...
map("n", "<leader>bb", action("workbench.action.quickOpenPreviousRecentlyUsedEditorInGroup"), opts("Switch to other buffer"))
...
-- Folds
map("n", "za", action("editor.toggleFold"), opts("Toggle fold"))
map("n", "zA", action("editor.toggleFoldRecursively"), opts("Toggle fold recursively"))
map("n", "zc", action("editor.fold"), opts("Fold"))
map("n", "zC", action("editor.foldRecursively"), opts("Fold recursively"))
map("n", "zo", action("editor.unfold"), opts("Unfold"))
map("n", "zO", action("editor.unfoldRecursively"), opts("Unfold recursively"))
map("n", "zM", action("editor.foldAll"), opts("Fold all"))
map("n", "zR", action("editor.unfoldAll"), opts("Unfold all"))
map("n", "zj", action("editor.gotoNextFold"), opts("Next fold"))
map("n", "zk", action("editor.gotoPreviousFold"), opts("Previous fold"))

map("n", "<leader>za", action("editor.toggleFold"), opts("Toggle fold"))
map("n", "<leader>zA", action("editor.toggleFoldRecursively"), opts("Toggle fold recursively"))
map("n", "<leader>zc", action("editor.fold"), opts("Fold"))
map("n", "<leader>zC", action("editor.foldRecursively"), opts("Fold recursively"))
map("n", "<leader>zh", action("editor.gotoParentFold"), opts("Parent fold"))
map("n", "<leader>zj", action("editor.gotoNextFold"), opts("Next fold"))
map("n", "<leader>zk", action("editor.gotoPreviousFold"), opts("Previous fold"))
map("n", "<leader>zM", action("editor.foldAll"), opts("Fold all"))
map("n", "<leader>zo", action("editor.unfold"), opts("Unfold"))
map("n", "<leader>zO", action("editor.unfoldRecursively"), opts("Unfold recursively"))
map("n", "<leader>zR", action("editor.unfoldAll"), opts("Unfold all"))
